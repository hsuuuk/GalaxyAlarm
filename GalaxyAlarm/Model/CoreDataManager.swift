...
final class CoreDataManager {
    ...
    func addAlarm(data: AlarmData, completion: @escaping () -> Void) {
        guard let context = context else { return }
        ...
        CoreData.midday = data.midday
        CoreData.time = data.time
        CoreData.date = Date()
        do {
            try context.save()
            completion()
    ...
    func deleteAlarm(data: CoreData, completion: @escaping () -> Void) {
        let request = NSFetchRequest<NSManagedObject>(entityName: name)
    ...
    func updateAlarm(newData: CoreData, completion: @escaping () -> Void) {
        let request = NSFetchRequest<NSManagedObject>(entityName: name)
